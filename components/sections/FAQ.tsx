...
const FAQ: React.FC = () => {
  ...
  const faqItems = [
    {
      question: "How is this different from traditional web scraping?",
      answer:
        "Scrpy uses client-side scraping that runs in the browser, bypassing all server-side restrictions like IP blocks, rate limits, and CAPTCHAs. Traditional scraping uses servers that can easily be detected and blocked.",
    ...
    },
    {
      ...
      answer:
        "Scrpy supports Claude Code, Kilo Code, Cline, OpenCode, and all major AI coding tools. We use the standard MCP (Model Context Protocol) which ensures compatibility with virtually any AI agent.",
    ...
    },
    {
      ...
      answer:
        "Absolutely. Scrpy processes all data client-side in your browser. Nothing is sent to external servers unless you explicitly choose to. All data transmission is encrypted with enterprise-grade security.",
    ...
    },
    {
      ...
      answer:
        "Yes! Scrpy is designed for both personal and commercial use. Our Pro and Enterprise plans include commercial licenses, SLA guarantees, and priority support.",
    ...
    },
    {
      ...
      answer:
        "Because Scrpy runs client-side, there are no traditional rate limits. The only limitations are your browser's capabilities and your plan's request quotas. Enterprise plans offer unlimited requests.",
    ...
    },
    {
      ...
      answer:
        "You can be up and running in under 60 seconds. Install the browser extension, enter your documentation URL, and you have a working MCP endpoint. No server setup required.",
    ...
    },
    {
      ...
      answer:
        "Not at all! Scrpy is designed to be developer-friendly but doesn't require extensive technical knowledge. Our intuitive interface and comprehensive documentation make it easy for users of all skill levels.",
      icon: <Users className="w-5 h-5" />,
      category: "Support",
    },
    {
      question: "What happens to my existing documentation?",
      answer:
        "Your documentation remains exactly where it is. Scrpy creates a layer on top that makes it accessible via MCP endpoints. No changes to your existing infrastructure are required.",
      ...
      <Container size="lg">
        ...
        <div className="text-center mb-16">
          ...
          <Body size="lg" className="max-w-3xl mx-auto text-stone-600 mb-8">
            Everything you need to know about Scrpy and how it transforms your
            documentation into intelligent MCP endpoints.
          </Body>
          ...
          <div className="space-y-3 sm:space-y-4">
            {faqItems.map((item, index) => (
              <div key={index} className="faq-item">
                <Card
                  className={`bg-white border-2 transition-all duration-300 cursor-pointer ${
                    openItem === index
